...
//        "无声的告别",
    ...
    randomLetter: function(color){
        ...
        var theLetter = this.letters[this.randomInt(0, this.letters.length)];
        element.innerHTML  = theLetter[this.randomInt(0, theLetter.length)];
...
var Rain = function(container, cursor){
    ...
    this.cursor = cursor;
    this.colors = Generator.gradient('#ec008c', '#ffffff');
    this.gravity = this.base_gravity = new Vector(0, 0.00175);
    this.drop_limit = this.base_drop_limit = 25;
    this.drops = [];
};
